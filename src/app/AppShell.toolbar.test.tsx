...
describe('AppShell toolbar', () => {
	...
	it('orders the three toolbar regions without duplicated controls', () => {
		...
		const about = screen.getByRole('button', { name: 'About Markdown Toolkit' })
		expect(right).toContainElement(ai)
		expect(right).toContainElement(about)
		...
		expect(ai.compareDocumentPosition(about) & Node.DOCUMENT_POSITION_FOLLOWING).toBeTruthy()
		expect(about.compareDocumentPosition(theme) & Node.DOCUMENT_POSITION_FOLLOWING).toBeTruthy()
